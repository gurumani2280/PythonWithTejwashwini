...
class Student(Person) : # child class inherting the parent class
    def __init__(self,firstname,lastname,age):
        ...
        print("Student class constructor")                      #TypeError: Student.__init__() takes 1 positional argument but 4 were given
    def IsStudent(self):
        return True                                        #changing the implementation in sun class as per the need of the sub class i.e., function overriding
S1 = Student("Ishaan","Atharv",2)
S1.PrintPersonDetails()                                   #AttributeError: 'Student' object has no attribute 'firstname'
